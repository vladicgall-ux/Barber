...
// VK Mini Apps don't hand you a single signed blob like Telegram/MAX do —
// the signed launch params (vk_user_id, sign, ...) are just the page's own
// query string.
export function getVkQueryString() {
  if (typeof window === 'undefined') return null;
